...
2. ***Commercial Use / Distribution***
   2.1 **Do not** sell or distribute the script *without linking to `GitHub`* by `pr0gramat0r-null`.
   ...
   2.2 All risks of using the script lie with the `user`.

3. ***Account Safety***
   3.1 Do *not* run the script `24/7` without breaks.
   ...
   3.2 But you have to install and configure it manually.  
...
###     > AUTHOR: -  ```pr0gramat0r```
###     > ***GitHub*** author: ```@pr0gramat0r-null```
____________________________________________________________________________________________________
...
##      > **You have question?** || **Need help?**  
##      > **Found bug or errors?** || **Have idea or task?**  
____________________________________________________________________________________________________
